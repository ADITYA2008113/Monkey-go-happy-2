var monkey,ground,banana,stone,invisibleGround;
...
var monkeyAnimation,bananaImage,StoneImage,groundImage,hartpoint;
...
"Monkey_04.png","Monkey_05.png","Monkey_06.png","Monkey_07.png","Monkey_08.png","Monkey_09.png","Monkey_10.png");
  ...
  hartpoint = loadImage("pixel-heart-2779422_960_720.webp");
...
function setup() {
  ...
  invigibleGround=createSprite(200,265,400,5);
  ...
  monkey.addAnimation("monkeyg",monkeyAnimation);
   monkey.scale=0.06;
  ...
  hart1=createSprite(20,20);
  hart1.addAnimation("heart1",hartpoint);
  hart1.scale=0.06;
  
  hart2 = createSprite(59,20);
  hart2.addAnimation("heart2",hartpoint);
  hart2.scale=0.06;
  
  gameOver = createSprite(300,130,10,10); 
  gameOver.addImage("GameOverT",gameOverImage);
  gameOver.scale=0.7;
...
function draw() {
  ...
  monkey.collide(invigibleGround);
